...
2. 오늘 요일(KST)로 대상 권역을 정한다(아래 "요일별 권역 로테이션").
   ...
   이후 설립, 1990~1999년은 예외 사유 명기), 이미 널리 알려진 유명·교과서적 사례 제외,
   상장기업은 하루 최대 1건(창업 지역에 본사가 남은 경우만). 규모는 작아도 된다 —
   연매출이 작은 소기업도 출처가 확인되면 채택한다. 오래된 상장 대기업 2건짜리 리포트는 실패다.
...
- **참신성:** 1990년 이전 설립 제외(기본 2000년 이후), 유명·교과서적 사례 제외,
  상장기업 하루 최대 1건. 규모는 작아도 됨(소기업 매출도 출처만 있으면 채택).
...
3. 확인 항목:
   ...
   - [ ] 참신성 필터가 동작하는가(1990년 이전 설립·유명 사례·상장 대기업 위주가 아닌가)
